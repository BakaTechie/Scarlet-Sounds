...
export function VideoPlayer() {
	...
	if (mirroredIds.includes(queueManager?.currentSong?.youtubeID) && useMirror) {
		videoType = 'url';
		queueManager.currentSong.videoURL = `//ghfast.top/https://raw.githubusercontent.com/BakaTechie/scarlet-sounds-files/refs/heads/master/${queueManager?.currentSong?.youtubeID}.mp4`
	}
